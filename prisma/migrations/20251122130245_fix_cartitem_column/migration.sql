-- CreateEnum
CREATE TYPE "OrderStats" AS ENUM ('PENDING', 'SUCCEEDED', 'CANCELED');
...
CREATE TABLE "VerifcationCode" (
    ...
    CONSTRAINT "VerifcationCode_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "VerifcationCode_userId_key" ON "VerifcationCode"("userId");
...
-- AddForeignKey
ALTER TABLE "VerifcationCode" ADD CONSTRAINT "VerifcationCode_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
